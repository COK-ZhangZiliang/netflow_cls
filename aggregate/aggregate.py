...
if __name__ == '__main__':
    ...
    # Load the files
    bng_file = "./datasets/benign.txt"
    mal_file = "./datasets/malicious.txt"
    ...
    for rate in sample_rate:
        ...
        save_to_csv(bng_traces, f'./datasets/traces/bng_{rate}.csv')
        save_to_csv(mal_traces, f'./datasets/traces/mal_{rate}.csv')
