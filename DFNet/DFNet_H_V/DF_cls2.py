...
def load_and_transform_data(data_path):
    ...
    print(len(data))
    data_for_cls = data.apply(lambda x: [[bytes, counts] for counts, bytes in x[0]])
    ...
    data_for_cls = data_for_cls.reshape((len(data_for_cls), 2, -1))
...
if __name__ == '__main__':
    ...
    sample_rate = [1, 5, 10, 15, 20, 25, 30, 60, 120, 180]
